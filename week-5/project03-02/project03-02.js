...
//creates and populates captions array
...
for (let i = 0; i < captions.length; i++) {
      htmlCode += `<figure><image alt='' src='slide${i}.jpg' /><figcaption>${captions[i]}</figcaption></figure>`;
}

//change innterHTML of elements with id "gallery"
